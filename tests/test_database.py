...
@pytest.mark.usefixtures("test_db")
@pytest.mark.asyncio
async def test_save_query_with_messages():
...
@pytest.mark.usefixtures("test_db")
@pytest.mark.asyncio
async def test_activate_generation():
...
@pytest.mark.usefixtures("test_db")
@pytest.mark.asyncio
async def test_activate_generation_deactivates_old():
...
@pytest.mark.usefixtures("test_db")
@pytest.mark.asyncio
async def test_cleanup_old_generations():
...
@pytest.mark.usefixtures("test_db")
@pytest.mark.asyncio
async def test_get_document_by_url_not_found():
...
@pytest.mark.usefixtures("test_db")
@pytest.mark.asyncio
async def test_save_and_get_sections():
...
@pytest.mark.usefixtures("test_db")
@pytest.mark.asyncio
async def test_search_sections_fts():
...
@pytest.mark.usefixtures("test_db")
@pytest.mark.asyncio
async def test_search_sections_fts_inactive_not_found():
...
@pytest.mark.usefixtures("test_db")
@pytest.mark.asyncio
async def test_delete_documents_by_domain():
...
@pytest.mark.usefixtures("test_db")
@pytest.mark.asyncio
async def test_delete_documents_by_domain_none_exist():
...
@pytest.mark.usefixtures("test_db")
@pytest.mark.asyncio
async def test_save_query_with_all_optional_fields():
...
@pytest.mark.usefixtures("test_db")
@pytest.mark.asyncio
async def test_save_query_unicode_content():
...
@pytest.mark.usefixtures("test_db")
@pytest.mark.asyncio
async def test_search_queries_case_insensitive():
...
@pytest.mark.usefixtures("test_db")
@pytest.mark.asyncio
async def test_search_queries_fts_word_match():
...
@pytest.mark.usefixtures("test_db")
@pytest.mark.asyncio
async def test_search_queries_respects_limit():
...
@pytest.mark.usefixtures("test_db")
@pytest.mark.asyncio
async def test_document_url_uniqueness():
...
@pytest.mark.usefixtures("test_db")
@pytest.mark.asyncio
async def test_save_rating_foreign_key_constraint():
